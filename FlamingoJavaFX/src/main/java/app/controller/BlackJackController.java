...
public class BlackJackController implements Initializable {
 ...
 private int iAnimationLength = 300;
 ...
 public void btnHit_Click(ActionEvent event) {
  ...
  // Create a Fade Transition would be fun
  FadeTransition ft =  CreateFadeTransition(img);
 ...
 private PathTransition CreatePathTransition(Point2D fromPoint, Point2D toPoint, ImageView img) {
  ...
  path.getElements().add(new CubicCurveTo(fromPoint.getX(), fromPoint.getY(), (fromPoint.getX() + toPoint.getX()) * 2,
    (fromPoint.getY() + toPoint.getY()) * 2, toPoint.getX(), toPoint.getY()));
  path.getElements().add(new CubicCurveTo(toPoint.getX(), toPoint.getY(), (fromPoint.getX() - toPoint.getX()) * 2,
 ...
 private FadeTransition CreateFadeTransition(ImageView img) {
  FadeTransition ft = new FadeTransition(Duration.millis(iAnimationLength),img);
  ft.setCycleCount(3);
